const Slide7 = () => {
    return (
        <div className={"w-full h-full flex flex-col items-center justify-center bg-cover bg-top bg-no-repeat bg-[linear-gradient(to_top,rgba(0,0,0,1),rgba(255,255,255,0)),url('/images/bg02.png')]"}>
